...
fun getWeatherLottieUrl(code: Int): String {
    return when (code) {
        0 -> "https://raw.githubusercontent.com/basmilius/weather-icons/main/production/lottie/clear-day.json"
        1, 2, 3 -> "https://raw.githubusercontent.com/basmilius/weather-icons/main/production/lottie/partly-cloudy-day.json"
        45, 48 -> "https://raw.githubusercontent.com/basmilius/weather-icons/main/production/lottie/fog.json"
        51, 53, 55, 61, 63, 65, 80, 81, 82 -> "https://raw.githubusercontent.com/basmilius/weather-icons/main/production/lottie/rain.json"
        71, 73, 75 -> "https://raw.githubusercontent.com/basmilius/weather-icons/main/production/lottie/snow.json"
        95, 96, 99 -> "https://raw.githubusercontent.com/basmilius/weather-icons/main/production/lottie/thunderstorms.json"
        else -> "https://raw.githubusercontent.com/basmilius/weather-icons/main/production/lottie/cloudy.json"
    }
}

@Composable
fun WeatherIcon(code: Int, modifier: Modifier = Modifier) {
    val lottieUrl = getWeatherLottieUrl(code)
